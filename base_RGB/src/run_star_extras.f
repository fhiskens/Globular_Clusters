...
! ***********************************************************************
      ...
      subroutine other_neu(  &
         ...
         if (initiate_load /= 1) then
             ...
             open(1, file = "/data/gpfs/projects/punim0011/fhiskens/HB_stars/axions/bases/base_RGB/g_fun_data.txt", &
             status = 'old', access = 'sequential', form = 'formatted', action = 'read')
             read(1,*) g_data
             close(1)
             
             ! Set up interpolation
             y0_test = log10(0.0906)
             y1_test = log10(1.216)
...
! set the correct summary file for the BC tables depending on [a/Fe]
      ...
      subroutine data_for_extra_history_columns(id, n, names, vals, ierr)
         ...
         names(6) = 'phase_of_evolution'
         vals(6) = s% phase_of_evolution
